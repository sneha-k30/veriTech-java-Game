...
class Game extends JPanel {
    ...
    private static Font FONT_M = new Font("Kalinga", Font.PLAIN, 24);
    private static Font FONT_M_ITALIC = new Font("Kalinga", Font.ITALIC, 24);
    private static Font FONT_L = new Font("Kalinga", Font.PLAIN, 84);
    private static Font FONT_XL = new Font("Kalinga", Font.PLAIN, 150);
    ...
    public Game() {
        ...
        setFocusable(true);
        setBackground(new Color(115, 237, 90));
    ...
    // Checking  if the snake has touch the wall or eaten itself
    ...
    // locating a cherry at a random places
    ...
    private void render(Graphics g) {
        ...
        g2d.setColor(new Color(199, 130, 33));
    ...
    // placing cherry in random position
...
// Movement and direction of snake
enum Direction { 
    UP, DOWN, LEFT, RIGHT;
